...
class Model:
	...
	def is_state_active(self, state):
		...
		if s == self.__State.main_region_turnleft:
			return self.__state_vector[0] == self.__State.main_region_turnleft
		return False
	...
	def __entry_action_main_region_forward(self):
		...
		self.output.speed = 0.3
		
	def __entry_action_main_region_turnleft(self):
	...
	def __exit_action_main_region_turnleft(self):
	...
	def __enter_sequence_main_region_turnleft_default(self):
		"""'default' enter sequence for state turnleft.
		"""
		self.__entry_action_main_region_turnleft()
		self.__state_vector[0] = self.State.main_region_turnleft
		self.__state_conf_vector_changed = True
	...
	def __exit_sequence_main_region_turnleft(self):
		"""Default exit sequence for state turnleft.
		"""
		self.__state_vector[0] = self.State.null_state
		self.__exit_action_main_region_turnleft()
	...
	def __exit_sequence_main_region(self):
		...
		elif state == self.State.main_region_turnleft:
			self.__exit_sequence_main_region_turnleft()
	...
	def __main_region_forward_react(self, transitioned_before):
		...
		if transitioned_after < 0:
			if self.__time_events[0]:
				...
				self.__exit_sequence_main_region_forward()
				self.__enter_sequence_main_region_turnleft_default()
				self.__react(0)
				transitioned_after = 0
		#If no transition was taken then execute local reactions
		if transitioned_after == transitioned_before:
	...
	def __main_region_turnleft_react(self, transitioned_before):
		"""Implementation of __main_region_turnleft_react function.
		"""
		transitioned_after = transitioned_before
		if transitioned_after < 0:
			if self.computer.w_press:
	...
	def __micro_step(self):
		...
		if state == self.State.main_region_stopped:
			...
			self.__main_region_turnleft_react(-1)
